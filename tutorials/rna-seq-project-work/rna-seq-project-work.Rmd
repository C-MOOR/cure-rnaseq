...
**The differential expression analysis available here and resulting DESeq2 object are identical to those from the original study which used age as a categorical value and sex as covariates (~age_categorical + sex) to look at differtial gene expression across different ages.**
