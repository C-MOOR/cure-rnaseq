...
if (file.exists(file_path)) {
  ...
  brain<-readRDS("/home/idies/workspace/c_moor_data/sharon-brain/brain.RDS")
  brain_metadata<-read.csv("/home/idies/workspace/c_moor_data/sharon-brain/brain_metadata.csv", row.names = 1)
