...
output$`user-files` <- renderPrint(list.files("~/workspace/klovett2/Storage/"))

```

```{r context="server"}
export_events <- function(event_location = ".", event_destination = ".") {
  print("session end")
  print(list.files(event_location))
  print(list.files(event_destination))
}
