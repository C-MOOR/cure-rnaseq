...
Welcome to the 16S miniCURE sampler! This module showcases key parts of our 16S Human Gut Microbiome miniCURE and highlights the features of learnr tutorials. 
...
quiz(caption = "Knowledge check: MISO study variables",
...
quiz(caption="Knowledge check: MISO metadata",
  ...
  question("Why are there fewer unique ages than there are unique subjects?",
    answer("Some people in the study are the same age", correct=TRUE),
    answer("Children and seniors are not allowed to partipate in the study"),
    answer("Age is measured in dog years"),
    allow_retry = TRUE,
    random_answer_order = TRUE
  )
)
