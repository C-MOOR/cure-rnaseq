...
file_path <- "/home/idies/workspace/c_moor_data/marianes-regions/htseq/midgut.tsv"
...
Use the `results()` and `formatDESeq2Results()` commands in the box below to look at a comparison between region "a1" and region "Cu" (replace "a1" and "p1" with the samples you want to compare).
