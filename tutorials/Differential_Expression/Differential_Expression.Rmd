...
#midgut_tsv <- read.table("../../temp_midgut_copy/midgut.tsv", header=TRUE)

# Load cached DESeq results
midgut <- readRDS("~/workspace/c_moor_data/instructors/preprocessed_data/marianes/marianes_htseq_DESeq.rds")
#midgut <- readRDS("../../temp_midgut_copy/marianes_htseq_DESeq.rds")


# Load cached clusterProfiler results (cached Dec 1 2021)
a1_vs_p1_clusters <- readRDS("~/workspace/c_moor_data/instructors/preprocessed_data/marianes/a1_vs_p1_clusters.rds")
#a1_vs_p1_clusters <- readRDS("../../temp_midgut_copy/a1_vs_p1_clusters.rds")
