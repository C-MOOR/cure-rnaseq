...
R1_vs_R1 <- formatDESeq2Results(raw_results)
R1_vs_R1
```
...
dim(sig_001_genes)
```
Now we get 1277 genes and we expect 0.001 X 1278 ~ 1 to be a false positive.  So we've basically gotten rid of all false genes, but we've also thrown out ~half of the real genes as compared to using the 0.05 cutoff.
