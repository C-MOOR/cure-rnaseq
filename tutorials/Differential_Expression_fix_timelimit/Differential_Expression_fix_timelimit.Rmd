...
#midgut_tsv <- read.table("/Users/katie/git/C-MOOR_github_account/cmoorData/data-raw/marianes_htseq/midgut.tsv", header=TRUE)
...
```{r clusterProfiler-practice, exercise=TRUE, fig.height=6, exercise.timelimit=120}
```
...
```{r getClusterProfilerGenes-practice, exercise=TRUE, exercise.timelimit=120}
```
...
```{r freeplayd-exercise, exercise=TRUE, exercise.eval=FALSE, exercise.timelimit=120}

```

```{r freeplayd2-exercise, exercise=TRUE, exercise.eval=FALSE, exercise.timelimit=120}

```

```{r freeplayd3-exercise, exercise=TRUE, exercise.eval=FALSE, exercise.timelimit=120}

```

```{r freeplayd4-exercise, exercise=TRUE, exercise.eval=FALSE, exercise.timelimit=120}

```

```{r freeplayd5-exercise, exercise=TRUE, exercise.eval=FALSE, exercise.timelimit=120}

```

```{r freeplayd6-exercise, exercise=TRUE, exercise.eval=FALSE, exercise.timelimit=120}
