...
#First, check if we are on SciServer by seeing if the file path to an htseq file on SciServer is available.
file_path <- "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891601.htseq"
if (file.exists(file_path)) {
  #If available, load in the files from SciServer
  ...
  #Sample data for Try it out! section
  SRR891601 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891601.htseq" )
  SRR891602 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891602.htseq" )
  SRR891603 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891603.htseq" )
  SRR891604 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891604.htseq" )
  SRR891605 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891605.htseq" )
  SRR891606 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891606.htseq" )
  SRR891607 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891607.htseq" )
  SRR891608 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891608.htseq" )
  SRR891609 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891609.htseq" )
  SRR891610 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891610.htseq" )
  SRR891611 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891611.htseq" )
  SRR891612 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891612.htseq" )
  SRR891613 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891613.htseq" )
  SRR891614 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891614.htseq" )
  SRR891615 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891615.htseq" )
  SRR891616 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891616.htseq" )
  SRR891617 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891617.htseq" )
  SRR891618 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891618.htseq" )
  SRR891619 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891619.htseq" )
  SRR891620 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891620.htseq" )
  SRR891621 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891621.htseq" )
  SRR891622 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891622.htseq" )
  SRR891623 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891623.htseq" )
  SRR891624 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891624.htseq" )
  SRR891625 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891625.htseq" )
  SRR891626 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891626.htseq" )
  SRR891627 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891627.htseq" )
  SRR891628 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891628.htseq" )
  SRR891629 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891629.htseq" )
  SRR891630 <- read.table( "/home/idies/workspace/c_moor_data/marianes-regions/htseq/SRR891630.htseq" )
  } else {
...
Replace `FILENAMEHERE` with the filename for the sample you want to examine **without the .htseq at the end**. For example, for sample `am1` (which contains data from the anterior region `a1_3`), the filename is `SRR891601'.

**You can always look back at other tabs and use the R cheat sheet to remind yourself how to set up a particular command.**
