...
quiz(caption = "Using plot_richness to plot alpha diversity",
  question("For subject S02, which diet has the HIGHEST alpha diveristy? HINT: the answer can be found in the alpha diversity plot where x = subject and color is by diet",
