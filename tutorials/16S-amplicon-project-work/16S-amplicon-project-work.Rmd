...
```{r barplot_subset_taxa, exercise=TRUE, echo=FALSE}
...
```{r barplot_subset_sample, exercise=TRUE, echo=FALSE}
...
```{r Try_it_plot_richness_metadata_subset, exercise=TRUE, echo=FALSE}
...
```{r Try_it_plot_richness_taxa_subset, exercise=TRUE, echo=FALSE}
...
```{r Try_it_plot_richness_blank3, exercise=TRUE, echo=FALSE}

```
```{r Try_it_plot_richness_blank4, exercise=TRUE, echo=FALSE}

```
```{r Try_it_plot_richness_blank5, exercise=TRUE, echo=FALSE}

```
```{r Try_it_plot_richness_blank6, exercise=TRUE, echo=FALSE}
...
### Multidimensional analysis (PCoA) code template
...
```{r Try_it_PCoA_subset_metadata, exercise=TRUE, echo=FALSE}
#Subset by metadata
...
```{r Try_it_PCoA_blank1, exercise=TRUE, echo=FALSE}
#Subset by taxa
...
```{r Try_it_PCoA_blank2, exercise=TRUE, echo=FALSE}

```

```{r Try_it_PCoA_blank3, exercise=TRUE, echo=FALSE}

```
```{r Try_it_PCoA_blank4, exercise=TRUE, echo=FALSE}

```
```{r Try_it_PCoA_blank5, exercise=TRUE, echo=FALSE}

```
```{r Try_it_PCoA_blank6, exercise=TRUE, echo=FALSE}
...
```{r Try_it_DA_blank1, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_blank2, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_blank3, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_blank4, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_blank5, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_blank6, exercise=TRUE, echo=FALSE}

```

### Differential abundance for continuous data code template
...
```{r Try_it_DA_continuous, exercise=TRUE, echo=FALSE}
...
```{r Try_it_DA_Continuous_blank1, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_Continuous_blank2, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_Continuous_blank3, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_Continuous_blank4, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_Continuous_blank5, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_Continuous_blank6, exercise=TRUE, echo=FALSE}

```

### Differential abundance for 0-inflated data code template
...
```{r Try_it_DA_zero-inf, exercise=TRUE, echo=FALSE}
# STEP 1: Convert the phyloseq object to a DESeq2 object and tell R the experimental design 
...
```{r Try_it_DA_zero-inf_blank1, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_zero-inf_blank2, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_zero-inf_blank3, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_zero-inf_blank4, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_zero-inf_blank5, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_zero-inf_blank6, exercise=TRUE, echo=FALSE}

```

### Differential abundance with continuous variables for 0-inflated data code template

#### What's different here?

- **How does this function differ from the above**: If you're here, that means you have a 0-inflated dataset AND are exploring the data using a continuous variable. 
- **Changes in the code**: This code is identical to the 0-inflated data code; we have changed the underlying function to handle 0-inflated data but these changes are invisible to you.

```{r Try_it_DA_continuous0inf, exercise=TRUE, echo=FALSE}
# STEP 1: Convert the phyloseq object to a DESeq2 object and tell R the experimental design
...
```{r Try_it_DA_continuous0inf_blank1, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_continuous0inf_blank2, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_continuous0inf_blank3, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_continuous0inf_blank4, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_continuous0inf_blank5, exercise=TRUE, echo=FALSE}

```

```{r Try_it_DA_continuous0inf_blank6, exercise=TRUE, echo=FALSE}
