...
There are several blocks for your convenience, use as many as you like.  **You can always look back at other tabs and use the [R cheat sheet](https://github.com/C-MOOR/cure-rnaseq/blob/master/tutorials/Rcheatsheet.md) to remind yourself how to set up a particular command.**
